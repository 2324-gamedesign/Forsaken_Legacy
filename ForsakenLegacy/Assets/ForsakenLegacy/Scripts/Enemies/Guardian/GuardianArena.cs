...
{
    public class GuardianArena : MonoBehaviour
    {
        ...
        public void StartPursuit()
        {
            ...
            //if it is still attacking wait for attack animation to stop and then continue logic
            if(isAttacking)
            {
        ...
        // protected bool IsPathToPatrolComplete()
        // {
